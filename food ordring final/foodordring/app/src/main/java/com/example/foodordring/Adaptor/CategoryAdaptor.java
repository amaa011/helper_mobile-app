...
ArrayList<CatigoryDomain>catigoryDomains;

    public CategoryAdaptor(ArrayList<CatigoryDomain> catigoryDomains) {
        this.catigoryDomains = catigoryDomains;
    }
...
holder.categoryName.setText(catigoryDomains.get(position).getTitle());
String picUrl="";
switch (position){
    case 0:{
        picUrl="cat_1";
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            categoryPic=itemView.findViewById(R.id.categeorypic);
